...
export function TemporalPage({globalFilters,setGlobalFilters}:DashboardProps){
 ...
 const hourEvents={click:(p:any)=>{ const index=Number(p?.dataIndex); if(globalFilters.source==="sejusp" && Number.isInteger(index)) setGlobalFilters({shift:shiftForHour(index)}) }}
